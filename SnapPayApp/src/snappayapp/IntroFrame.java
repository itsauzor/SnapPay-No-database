...
public class IntroFrame extends javax.swing.JFrame {
        ...
        int width = getWidth();
        int height = getHeight();
        Color color1 = new Color(51, 145, 88);
        Color color2 = new Color(86, 180, 211);
        GradientPaint gp = new GradientPaint(0, 0, color1, 180, height, color2);
        g2d.setPaint(gp);
        g2d.fillRect(0, 0, width, height);
        ...
        private void initComponents() {
                ...
                jLabel29.setIcon(new javax.swing.ImageIcon(getClass().getResource("/snapassets/Picsart-24-06-12-19-51-12-190.png"))); // NOI18N
                jPanel3.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 20, 130, 130));

                jLabel28.setIcon(new javax.swing.ImageIcon(getClass().getResource("/snapassets/Picsart-24-06-12-19-55-08-000.png"))); // NOI18N
                ...
                jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, -1, -1));
                ...
                jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, -1, -1));
